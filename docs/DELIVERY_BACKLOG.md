...
**Current stage:** Build Guide Step 4 server vision is implemented and tested. A live walking-person acceptance run and all Android overlay/aura slices remain.
...
| 2. Vision | PC returns up to six person track boxes and simplified contours. | FR-04, FR-11 | Automated decode/filter/normalization tests pass; live walking subject gets a temporary ID; malformed input recovers. |
