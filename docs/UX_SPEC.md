...
**Current stage:** Stage 5 — a baseline subject box/contour and temporary ID are implemented in the scanner; selection, live readings, scans, and effects remain planned.
